...
Header.prototype.setHeader = function(name, value) {
...
Header.prototype.removeHeader = function(name) {
  if (arguments.length < 1) {
...
Header.prototype._renderHeaders = function() {
  if (this._header) {
...
Object.defineProperty(Header.prototype, 'headersSent', {
  configurable: true,
  enumerable: true,
...
Header.prototype.write = function(chunk, encoding, callback) {
  if (!this._header) {
...
Header.prototype.addTrailers = function(headers) {
  this._trailer = '';
  var keys = Object.keys(headers);
  var isArray = util.isArray(headers);
  var field, value;
